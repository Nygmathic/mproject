...
description: "Reverend Jesse Louis Jackson — minister, warrior, dreamer — died peacefully on February 17, 2026, at the age of 84. The world pauses to honour a man who carried hope like a torch and refused, for more than six decades, to let it go out."
draft: false

# ─── Pinning ───────────────────────────────────────────────
pin: true                     # show this post pinned at the top of the homepage
pin_expiry: "2026-03-17"      # optional: pin auto-expires on this date (remove line to pin forever)

# ─── Image visibility per context ──────────────────────────
show_image_homepage: true     # show feature image in the homepage pinned/latest section
show_image_list: true         # show feature image on category/tag list pages
show_image_article: true      # show feature image at the top of the article itself
---
